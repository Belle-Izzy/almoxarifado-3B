...
- Documentando o Código - PHPDoc

É um padrão de documentação para PHP.

Utiliza blocos de comentários estruturados (iniciados com / ** ) logo acima de classes, métodos e
funções.

Permite descrever a finalidade do código, os tipos de dados esperados e os valores de retorno.
